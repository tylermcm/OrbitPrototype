...
{
	constexpr double g = 9.80665; // gravity at sea level in m/s^2
	constexpr double r = 6378000; // radius of the Earth in meters
...
// Function to compute the total component of acceleration
double Physics::computeTotalComponent(double ddx, double ddy) const
{
